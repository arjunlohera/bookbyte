...
<body class="<?= $body_class; ?>" style="position: relative;">
 ...
 <div id="wrapper">
<?php if($sidebar) { 
    if($this->Auth->get_user_type() == "ADMINISTRATOR"){ include "admin-sidebar.php";  }
    if($this->Auth->get_user_type() == "USER"){ include "user-sidebar.php";  }
 }?>
<!-- Content Wrapper -->
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$this->Auth->get_full_name();?></span>
          <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60">
        </a>
        <!-- Dropdown - User Information -->
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
            <?php if($this->Auth->get_user_type() == "USER") {?>
